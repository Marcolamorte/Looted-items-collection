...
store.add(WD('Q2668072'), DCTERMS('spatial'), WD('Q29520'));
...
store.add(WD('Q213322'),  WDT('P276'),  WD('Q84'));
...
store.add(WD('Q213322'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P22i_acquired_title_through'), CRM('E96'));
store.add(CRM('E96'), DCTERMS('temporal'), literal('19th-20th century'));
...
store.add(WD('Q2668072'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P24i_changed_ownership_through'), CRM('E96'));
...
store.add(WD('Q907894'),  WDT('P276'),  WD('Q29520'));
...
store.add(WD('Q334452'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P23i_surrendered_title_through'), WD('Q192623'));
store.add(WD('Q192623'), RDF('type'), CRM('E7'));
store.add(WD('Q192623'), RDFS('label'), literal('British and French Plunder'));
store.add(WD('Q192623'), CRM('P17'), WD('Q418151'));
store.add(WD('Q192623'), CRM('P14'), WD('Q222595'));
...
store.add(WD('Q2668072'), CRM('P25'), WD('Q418151'));
...
store.add(CRM('E52'), RDFS('label'), literal('8 October 1856 – 24 October 1860'));
store.add(WD('Q2668072'), CRM('P10'), CRM('E2'));
store.add(CRM('E2'), RDFS('label'), literal('Western Colonialism in China'));
store.add(CRM('E2'), CRM('P4'), DCTERMS('PeriodOfTime'));
