...
store.add(WD('Q212797'), CRM('P44'), CRM('E3'));
...
store.add(WD('Q7837116'), RDF('type'), CRM('E7'));
...
store.add(WD('Q1688607'),  WDT('P276'), WD('Q84'));
...
store.add(WD('Q22424'), WDT('P276'), WD('Q668'));
...
store.add(WD('Q212797'), CRM('P25'), WD('Q243590'));
