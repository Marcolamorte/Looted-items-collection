...
store.add(WD('Q248101'), DC('title'), literal('The Benin Bronzes Collection'));
store.add(WD('Q248101'), DC('type'), literal('Sculpture'));
store.add(WD('Q248101'), DC('type'), literal('Metal plaque'));
...
store.add(WD('Q248101'), CRM('P51'), WD('Q171203'));
store.add(WD('Q171203'),  SKOS('altLabel'), literal('Benin Kingdom'));
store.add(WD('Q248101'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P24i_changed_ownership_through'), ITO('British_Plunder'));
store.add(WD('Q248101'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P24i_changed_ownership_through'), WD('Q707482'));
store.add(WD('Q248101'), CRM('P55'), WD('Q6373'));
store.add(WD('Q248101'), CRM('P27'), WD('Q110925320'));
store.add(WD('Q248101'), CRM('P26'), WD('Q84'));
store.add(WD('Q248101'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P25i_moved_by'), ITO('British_Plunder'));
store.add(WD('Q248101'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P12i_was_present_at'), WD('Q3966451'));
...
store.add(ITO('British_Plunder'), CRM('P17'), WD('Q3966451'));
...
store.add(WD('Q723992'),  namedNode('http://www.cidoc-crm.org/cidoc-crm/P11i_participated_in'), WD('Q3966451'));
store.add(WD('Q723992'), RDF('type'), CRM('E39'));
...
store.add (WD('Q171203'), RDF('type'), CRM ('E39'));
store.add(WD('Q171203'), namedNode('http://www.cidoc-crm.org/cidoc-crm/P23i_surrendered_title_through'), ITO('British_Plunder'));
...
// Salva il file RDF
salvaGrafo('C:\\Users\\HWRUser\\Desktop\\DHDK Course\\Web Design and Technologies\\Vitali project\\rdf_files_graphs\\1_Africa_Benin_Bronzes.rdf');