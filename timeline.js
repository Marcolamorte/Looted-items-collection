document.addEventListener('DOMContentLoaded', function() {
    ...
    slider.addEventListener('input', () => {
        ...
        // Update the eraInfo with title and description
